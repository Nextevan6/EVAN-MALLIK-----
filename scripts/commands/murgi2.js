...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি যে খান*কির পোলা কে  চুদ*তে চান তাকে @ম্যানশন করেন আমি XUদে দেই 😞💯", event.threadID);
...
setTimeout(() => {a({body: "Hi ইভান এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi ইভান এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
