...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি যে মেয়েকে চুদ*তে চান সে মেয়েকে @ম্যানশন দেন আমি XUদে দেই 😓💯", event.threadID);
...
setTimeout(() => {a({body: "Hi ইভান এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi ইভান এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
